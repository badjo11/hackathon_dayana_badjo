...
//             <div >
//                 <h2 style={{ marginBottom: '25px', marginTop: '25px', color: '#31B8BF', }}>Страница заказов</h2>
//                 <Formik
//                     validationSchema={schema}
//                     onSubmit={handleSubmit}
//                     initialValues={{
...
//                 </Formik>
//             </div>
//             <div style={{ background: 'linear-gradient(135deg, #3C8CE7 2.6%, #33AEC8 40.47%, #31B8BF 51.04%, #3C8CE7 100%)' }} >
//                 dhjhdfj
//             </div>
//         </div >
//     );
